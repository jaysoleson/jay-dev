...
class HerbSupply:
    ...
    def get_status_message(self, med_cat):
        ...
        for message in messages.copy():
            if "lead_name" in message and (not game.clan.baron or game.clan.baron.dead or game.clan.baron.outside):
                messages.remove(message)
            if "dep_name" in message and (not game.clan.regent or game.clan.regent.dead or game.clan.regent.outside):
                messages.remove(message)
