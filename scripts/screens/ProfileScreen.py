...
from ..game_structure.windows import ChangeCatName, KillCat, ChangeCatToggles, SpecifyCatSexuality
...
class ProfileScreen(Screens):
    ...
    def toggle_accessories_tab(self):
        ...
        if previous_open_tab == 'accessories':
            ...
            self.add_perma_inventory = UIImageButton(
                ui_scale(pygame.Rect((55, 580), (34, 34))), "",
                object_id="#add_permainventory_button",
                tool_tip_text="Add worn flag to permanent inventory. Flags in the permanent flag inventory will not be affected by auto-equip based on the cat's orientation.",
                manager=MANAGER
                )
            
            self.remove_perma_inventory = UIImageButton(
                ui_scale(pygame.Rect((55, 542), (34, 34))),
                "",
                object_id="#remove_permainventory_button",
                tool_tip_text="Remove worn accessories from permanent flag inventory",
                manager=MANAGER
                )
            # ---
    ...
    def toggle_personal_tab(self):
        ...
        if previous_open_tab == "personal":
            ...
            self.specify_sexuality_button = UIImageButton(
                ui_scale(pygame.Rect((575, 543), (176, 30))),
                "",
                starting_height=2,
