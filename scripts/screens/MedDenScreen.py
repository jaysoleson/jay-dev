...
class MedDenScreen(Screens):
    ...
    def screen_switches(self):
        ...
        self.treatment_button = UIImageButton(
            ui_scale(pygame.Rect((537, 80), (201, 60))),
            "",
            object_id="#attempt_cure_button",
            manager=MANAGER
        )
        ...
        if (
            ...
            get_infected_clan_cat_count(Cat) == 0 or
            len(medcats) <= 0) and
            "cure_found" not in game.clan.infection["logs"]
            ):
