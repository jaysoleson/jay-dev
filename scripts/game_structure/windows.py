...
class SpecifyCatSexuality(UIWindow):
    ...
    def __init__(self, cat):
        super().__init__(ui_scale(pygame.Rect((300, 215), (400, 250))),
        ...
        self.heading = pygame_gui.elements.UITextBox(
            ...
            ui_scale(pygame.Rect((10, 10), (380, 75))),
            object_id="#text_box_30_horizcenter_spacing_95",
            manager=MANAGER,
            container=self)
        ...
        self.label_changed = pygame_gui.elements.UITextBox(
            "Label changed!",
            ui_scale(pygame.Rect((142, 132), (400, 150))),
            visible=False,
            object_id="#text_box_30_horizleft",
            manager=MANAGER,
            container=self
        ...
        self.nonetext = pygame_gui.elements.UITextBox(
            "None",
            ui_scale(pygame.Rect((2, 77), (100, 37))),
            object_id="#text_box_22_horizcenter",
            manager=MANAGER,
            container=self
            )
        ...
        self.tomtext = pygame_gui.elements.UITextBox(
            "Toms",
            ui_scale(pygame.Rect((2, 107), (100, 37))),
            object_id="#text_box_22_horizcenter",
            manager=MANAGER,
            container=self
            )
        ...
        self.shecattext = pygame_gui.elements.UITextBox(
            "She-cats",
            ui_scale(pygame.Rect((2, 137), (100, 37))),
            object_id="#text_box_22_horizcenter",
            manager=MANAGER,
            container=self
            )
        ...
        self.removetext = pygame_gui.elements.UITextBox(
            "Reset label",
            ui_scale(pygame.Rect((0, 177), (100, 37))),
            object_id="#text_box_22_horizcenter",
            manager=MANAGER,
            container=self
            )
...
class ChangeCatToggles(UIWindow):
    ...
    def __init__(self, cat):
        ...
        self.text_7 = pygame_gui.elements.UITextBox("Prevent gender changes",
                                                    ui_scale(pygame.Rect(60, 175, -1, 50)), 
                                                    object_id="#text_box_30_horizleft_pad_0_8",
                                                    container=self)
        self.text_8 = pygame_gui.elements.UITextBox("Set neutral faith",
                                                    ui_scale(pygame.Rect(60, 200, -1, 50)), 
                                                    object_id="#text_box_30_horizleft_pad_0_8",
                                                    container=self)
        # Text
