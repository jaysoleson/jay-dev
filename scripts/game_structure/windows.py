...
class ChangeCatClanName(UIWindow):
    """This window allows the user to change the cat's name
    for the warrior cat names setting"""
...
class ChangeCatName(UIWindow):
    """This window allows the user to change the cat's name.
    for the "prefix only" name setting"""
    ...
    def __init__(self, cat):
        ...
        self.one_life_check = UIImageButton(
            ...
            tool_tip_text=process_text(
                i18n.t("windows.all_lives_baron_tooltip"),
                cat_dict,
            ),
            manager=MANAGER,
            container=self,
        ...
        if self.the_cat.status == "baron":
            ...
            # This should only occur for retired barons.

            self.prompt = process_text(i18n.t("windows.death_prompt"), cat_dict)
            self.initial = process_text(
                i18n.t("windows.default_baron_death"), cat_dict
            )
            self.all_lives_check.hide()
