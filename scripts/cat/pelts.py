...
class Pelt():
    ...
    pridebandanas3 = [
        "URANIC", "NEBULAROMANTIC", "CATGENDER", "GENDERDOE", "OMNISAPPHIC", "MOTHGENDER", "SNOWLEOPARDGENDER", "TIGERGENDER", "BUGGENDER", "GENDERFAUN", "DEMIAROACE", "SAPPHIC", "ACHILLEAN", "XENOGENDER", "GENDERFLUX"
    ]

    pridebandanas4 = [
        "PLACEHOLDER", "MOSSGENDER", "MOONGENDER", "SUNGENDER", "STARGENDER", "APAGENDER", "UNLABELLED", "QUESTIONING"
    ]

    customflags = [
        "CUSTOMFLAG0", "CUSTOMFLAG1", "CUSTOMFLAG2", "CUSTOMFLAG3", "CUSTOMFLAG4", "CUSTOMFLAG5", "CUSTOMFLAG6", "CUSTOMFLAG7", "CUSTOMFLAG8" 
    ]
