...
class Pelt:
    ...
    eye_colours = ['YELLOW', 'AMBER', 'HAZEL', 'PALEGREEN', 'GREEN', 'BLUE', 'DARKBLUE', 'GREY', 'CYAN', 'EMERALD',
                   ...
                   'BRONZE', 'SILVER', 'PRISM', 'COTTONCANDY']
    ...
    pridebandanas = [
        ...
        'NEPTUNIC', 'LITHROMANTIC', 'CUPIOROMANTIC', 'QUEERPLATONIC', 'AROACEFLUX',
        'BIGENDER', 'AGENDER'
    ]

    pridebandanas2 = [
        "GENDERFLUID", "AMBIGUOUS", "INTERSEX", "RAINBOWBANDANA", "GAY",
        "LESBIAN", "BI", "AROACE", "PAN", "POLYAM", "DEMI", "GRAYACE",
        "ACE", "ARO", "DEMIROMANTIC"
    ]

    pridebandanas3 = [
        "URANIC", "NEBULAROMANTIC", "CATGENDER", "GENDERDOE", "OMNISAPPHIC",
        "MOTHGENDER", "SNOWLEOPARDGENDER", "TIGERGENDER", "BUGGENDER", "GENDERFAUN",
        "DEMIAROACE", "SAPPHIC", "ACHILLEAN", "XENOGENDER", "GENDERFLUX"
    ]

    pridebandanas4 = [
        "PLACEHOLDER", "MOSSGENDER", "MOONGENDER", "SUNGENDER", "STARGENDER",
        "APAGENDER", "UNLABELLED", "QUESTIONING", "POLYSEXUAL", "OMNISEXUAL", "ARKHAIGENDER",
        "ARCHAEOGENDER", "DEMIFLUID", "GREYAROACE"
    ]

    customflags = [
        "CUSTOMFLAG0", "CUSTOMFLAG1", "CUSTOMFLAG2", "CUSTOMFLAG3",
        "CUSTOMFLAG4", "CUSTOMFLAG5", "CUSTOMFLAG6", "CUSTOMFLAG7",
        "CUSTOMFLAG8" 
    ]
    ...
    eye_sprites = [
        ...
        'SUNLITICE', 'GREENYELLOW', 'BRONZE', 'SILVER', 'PRISM', 'COTTONCANDY'
    ]
    ...
    mid_white = ['TUXEDO', 'FANCY', 'UNDERS', 'DAMIEN', 'SKUNK', 'MITAINE', 'SQUEAKS', 'STAR', 'WINGS',
                 ...
                 'VEST',
                 'FADEBELLY', 'DIGIT', 'FCTWO', 'FCONE', 'MIA', 'ROSINA', 'PRINCESS', 'DOUGIE', 'APPLECLAW']
