...
| "old_name"                                  | Ensure the cat keeps their old (maybe nomad or kittypet) name. Doesn't work for kittens or litters.                                                                                                                                                                                                                                                                  |
...
| "nomad"                                     | Gives the cat a nomad type backstory. If "meeting" is also included, this tag will make the cat an nomad outsider                                                                                                                                                                                                                                                    |
...
| "backstory:{some}, {backstories},{another}" | Comma-separated exact backstories to pick from. Overrides "kittypet", "nomad", "clancat"                                                                                                                                                                                                                                                                             |
...
#### outsider_rep
> This parameter is used for **all** patrols that involve new_cats, nomads, and rogues (regardless of if the new cat joins, or if the nomad or rogue is even open to joining the clan). It changes the reputation the player Clan has among outsiders, those who don't belong to any Clan. 
>
...
>
> Please check with the other developers before changing from these defaults. However, there are lots of reasons why outsider_rep might be effected more or less than these defaults. For example, rescuing a mother cats and her newborn kittens may have a greater positive effect on a Clan's reputation than allowing random nomad number 27 to join the Clan.
