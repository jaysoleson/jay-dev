...
def reformat():
    for path in file_set:
        ...
        for t in thoughts_dict:
            # LG edit: thought is already reformatted
            if "strings" in t:
                ...
                if t.get("main_cluster_constraint"):
                    m_c["cluster"] = t.get("main_cluster_constraint")
                if t.get("main_faith_constraint"):
                    m_c["cluster"] = t.get("main_faith_constraint")
                ...
                if t.get("random_faith_constraint"):
                    r_c["min_max_faith"] = t.get("random_faith_constraint")
